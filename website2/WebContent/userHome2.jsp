...
<head>
       ...
       /* unvisited */
        ...
        <body>
            ...
            <!-- Begin Page Content -->
            <div id="container">
                <form method="post" action="createpasswd2.jsp" >
                	<%
                    ...
                    <input type="text" id="pass" name="username" required placeholder="Only for new user">
                     
                    <div id="lower">
                        <br>
                        <a href="loginpage2.jsp">Existing User- Login </a>
