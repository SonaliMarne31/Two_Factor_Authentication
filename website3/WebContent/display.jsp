...
<body onload="start()">
     ...
     <style>
        ...
        input[type=submit]:active {
         ...
         input[type=button]:enabled{
            ...
            background-image: -moz-linear-gradient(top left 90deg, #acd6ef 0%, green 100%);
            background-image: linear-gradient(top left 90deg, green 0%, green 100%);
        }
        ...
        function preventBackspace(e) {
            ...
            if (evt) {
                ...
                if (keyCode === 8) {
                	alert("backspace not allowed press reset to Relearn");
        ...
        function checkPass1()
        {
            	...
            	
  		  {
            	...
            	if(pass1.charAt(1)==str.charAt(1))
            		...
            		document.getElementById("pic").src="images/prev.jpg"; 
                	document.getElementById("secondarypassword").value = "";
            	    flag=-1;
            		}
	        	 ...
	        	 if(pass1.substring(0,5)==str.substring(0,5))
		 			{
		               ...
		               var c2="images/"
		            	var res = c2.concat(c1)
		                document.getElementById("pic").src="images/success.jpg";
		               st.style.backgroundColor = goodColor;
		               document.getElementById("Register").disabled = false;
    ...
    <div id="container">
    <form action="registrationsuccess.jsp" method="get" id="form1">
        
        <div align="center">
            <img src= alt="Mountain View" style="width:210px;height:210px;" name="pic" id="pic"  >
            
        </div>
            <input type="text"  id="secondarypassword" name="secondarypassword" placeholder="Enter secondary password" onkeyup="checkPass1(); return false;"  onKeyDown="preventBackspace();" ><br>
       ...
       <div id="lower">
        ...
        <input align="center" type="button" id="Reset" value="Reset" onclick="reset()"  />
   </div>
