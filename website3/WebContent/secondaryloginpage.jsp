...
<%
	...
	PreparedStatement pst = connection.prepareStatement("Select username from registration_graphical where username=?");
	...
	<div id="container">
		<form method="post" action="loginsuccess.jsp">
			...
			<div class="row">
				...
				<label for="primarypassword">Primary Password :</label> <input
					type="password" id="primarypassword" name="primarypassword">
				<span id="confirmMessage1" class="confirmMessage"></span> <label
					for="password">Secondary Password:</label> <input type="password"
					id="secondarypassword" name="secondarypassword"> <span
					id="confirmMessage2" class="confirmMessage"></span>
